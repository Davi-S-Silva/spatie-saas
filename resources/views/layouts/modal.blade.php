        ...
        <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
            ...
            >
                ...
                <p class="mt-2 text-sm text-gray-500 ">
                    Para cada Acao vamos ter um modal form desse
                </p>

                <form class="mt-5" action="{{ route('dashboard') }}" name="formModalTeste" method="post">
                    <div>
                    ...
                    <div class="flex justify-end mt-6">
                        <input type="submit" class="px-3 py-2 text-sm tracking-wide
                         text-white capitalize transition-colors duration-200 transform
                          bg-indigo-500 rounded-md dark:bg-indigo-600
                          dark:hover:bg-indigo-700 dark:focus:bg-indigo-700
                          hover:bg-indigo-600 focus:outline-none focus:bg-indigo-500
