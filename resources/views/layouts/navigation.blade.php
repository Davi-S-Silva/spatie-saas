...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('carga.index')" :active="request()->routeIs('carga.index')">
                {{ __('Cargas') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">{{ Auth::user()->name }} - {{ str_replace('tenant-','',Auth::user()->roles->first()->name) }}</div>
